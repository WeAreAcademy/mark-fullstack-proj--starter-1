 ...
 */
export function prepareErrorForClient(error: unknown): { errorMsg: string; errorObj?: Error; stackTrace?: string; } {
    if (error instanceof Error) {
        return { errorMsg: error.message, errorObj: error, stackTrace: error.stack };
    } else {
